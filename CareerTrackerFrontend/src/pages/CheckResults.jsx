...
const CheckResults = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get('/api/active_applications');
  ...
  return (
    <div className="flex flex-col m-2 md:m-10 mt-24 p-2 md:p-10 bg-white rounded-2xl">
      <h1 style={{ color: currentColor, fontSize: '2rem', marginBottom: '10px' }} className="font-bold">Check All Active Applications</h1>
